...
public class MainMapperTest {
    ...
    @Test
    void selWineByPrice25() {WineSelDto selDto = new WineSelDto();
        selDto.setPage(1);
        selDto.setStartIdx(1);
        selDto.setRow(9);
        List<WineTotalVo> list = MAPPER.selWineByPrice25(selDto);
        assertEquals(9, list.size());
        ...
        for (WineTotalVo vo : list) {
            ...
            assertEquals(item.getBeginner(), vo.getBeginner());
            assertEquals(item.getAlcohol(), vo.getAlcohol());
            assertEquals(item.getPrice() > 20000 && item.getPrice() < 50000, vo.getPrice() > 20000 && vo.getPrice() < 50000);
        }
    }

    @Test
    void selWineByPrice510() {
        WineSelDto selDto = new WineSelDto();
        selDto.setPage(1);
        selDto.setStartIdx(1);
        selDto.setRow(9);
        List<WineTotalVo> list = MAPPER.selWineByPrice510(selDto);
        assertEquals(9, list.size());
        ...
        for (WineTotalVo vo : list) {
            ...
            assertEquals(item.getBeginner(), vo.getBeginner());
            assertEquals(item.getAlcohol(), vo.getAlcohol());
            assertEquals(item.getPrice() > 50000 && item.getPrice() < 100000, vo.getPrice() > 50000 && vo.getPrice() < 100000);
        }
    }

    @Test
    void selWineByPrice10() {
        WineSelDto selDto = new WineSelDto();
        selDto.setPage(1);
        selDto.setStartIdx(1);
        selDto.setRow(9);
        List<WineTotalVo> list = MAPPER.selWineByPrice10(selDto);
        assertEquals(9, list.size());
        ...
        for (WineTotalVo vo : list) {
            ...
            assertEquals(item.getBeginner(), vo.getBeginner());
            assertEquals(item.getAlcohol(), vo.getAlcohol());
            assertEquals(item.getPrice() > 100000, vo.getPrice() > 100000);
        }
    }
    ...
    @Test
    void selWineByFood() {
        WineSelByFoodDto foodDto = new WineSelByFoodDto();
        foodDto.setBigCategoryId(1L);
        foodDto.setPage(1);
        foodDto.setStartIdx(1);
        foodDto.setRow(9);
        List<WineTotalVo> list = MAPPER.selWineByFood(foodDto);
        assertEquals(9, list.size());
